...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <br><br><br>
      <form:form modelAttribute="user" action="/register" method="post" acceptCharset="UTF-8">
        <fieldset>
          <!-- ЗАГОЛОВОК ФОРМЫ -->
          ...
          <div class="form-group">
            <div class="text-right">
              <div id="Group" class="btn-group" role="group" aria-label="">
                <input type="submit" name="" class="btn btn-success" aria-label="Создать пользователя" value="Создать пользователя">
