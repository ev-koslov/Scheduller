...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <br><br><br>
      <form:form modelAttribute="user" action="/user/edit" method="post" acceptCharset="UTF-8">
        <fieldset>
          <!-- ЗАГОЛОВОК ФОРМЫ -->
          ...
          <div class="form-group">
            <div class="text-right">
              <div id="Group" class="btn-group" role="group" aria-label="">
                <input type="submit" name="" class="btn btn-success" aria-label="Сохранить изменения" value="Сохранить изменения">
                <input type="button" name="" class="btn btn-warning" aria-label="Отменить изменения" value="Отменить изменения" onclick="location.reload()">
                <input type="button" name="" class="btn btn-default" aria-label="Назад" value="Назад" onclick="location.href='/'">
              </div>
            </div>
          </div>
