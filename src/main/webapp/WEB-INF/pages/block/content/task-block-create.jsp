...
<form class="form-horizontal" action="/task/create" method="post" acceptCharset="UTF-8" id = "form">
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="date" name="toDoDate" id = "toDoDate" type="date" class="form-control"/>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="text-right col-sm-4">
        <div id="Group" class="btn-group" role="group" aria-label="">
          <button type="button" name="" class="btn btn-success" aria-label="Создать" onclick="script_task_block_edit.submitFormTask()">Создать задачу</button>
...
<div id="subTaskElementHTML" style="display: none;">
  <div class='row' style='padding-bottom: 5px;'>
    <div class='col-md-9'><input type='text' class='form-control' name='subTaskList[0].text'
